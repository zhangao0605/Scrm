function Tag(inputId){
	...
	obj.initView=function(){
		...
		appendStr+='<div class="tagList"></div><input type="text" class="tagInput" placeholder="请输入标签名称"/>';
		appendStr+='</div>';
...
var tagTake ={
	...
	"getTagItemModel":function(valueStr){
		return '<div class="tagItem tagItem1" id="0"><span>'+valueStr+'</span><div class="delete"></div></div>';
	}
}
